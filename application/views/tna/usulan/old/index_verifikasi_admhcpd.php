                    ...
                    <div class="box-header with-border">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <div class="pull-right">
                                <a href ="#" data-toggle="modal" data-target="#ModalUploadVerifikasiVP"><button class="btn btn-info btn-sm">
                                        <i class="glyphicon glyphicon-upload"></i> Upload Verifikasi VP
                                    </button>
                                </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>Verifikasi</li>
                                                    <li>Riwayat</li>
                                                    <li><a href="<?php echo site_url('tna/usulan/edit');?>"> Edit</a></li>
                                                </ul>
                                                </div>
                                            </td>
                                        </tr>
