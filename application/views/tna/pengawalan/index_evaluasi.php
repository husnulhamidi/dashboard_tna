                        ...
                        <div class="col-lg-12">
                            <ul class="nav nav-tabs">
                                ...
                                <div class="pull-right">
                                    ...
                                    <button class="btn btn-success btn-sm" id="btnEvaluasi">
...
<script type="text/javascript">
    $(document).on('change', '#checkboxAll', function() {
        // Mengatur status centang semua kotak centang lainnya
        $('input[name="checkbox-evalusi[]"]').prop('checked', this.checked);
    });
</script>