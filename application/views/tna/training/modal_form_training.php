<!-- Modal -->
<div class="modal fade" id="AddTraining" tabindex="-1" role="dialog" aria-hidden="true" enctype="multipart/form-data">
    <div class="modal-dialog modal-lg" >
        <div class="modal-content">
            <div class="modal-header bg-info">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="false">&times;</button>
                <h4 class="modal-title" id="myModalLabel"> Form Tambah Training</h4>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="select2 form-control" name="pilih_produk" id="pilih_produk" multiple>
                                            <option value=""></option>
                                        </select>
                                    </div>
                                </div>
