...
function getFeedback(id){
    $('#tbl-feedback').DataTable({
        ...
        order: [], 
        ajax: {
            url     : base_url+"/internalSharing/getFeedback/"+id,
            type    : "get",
            datatype: "json",
            data    : function(d){
                console.log(d)
        ...
        columns: [
            ...
            { 
                ...
                render:function(data){
                    var grade = '';
                    if(data >= 15 ) grade = 'Baik Sekali';
                    if(data >= 12 && data < 15) grade = 'Baik';
                    if(data >= 10 && data < 12) grade = 'Cukup';
                    if(data >= 6 && data < 10) grade = 'Kurang Baik';
                    if(data < 6 ) grade = 'Tidak Baik';
                    return grade
                }
            },
            { 
                "data": "skor_narasumber" ,
                render:function(data){
                    var grade = '';
                    if(data >= 15 ) grade = 'Baik Sekali';
                    if(data >= 12 && data < 15) grade = 'Baik';
